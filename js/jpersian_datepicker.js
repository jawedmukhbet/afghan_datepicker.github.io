window.jpersian_datepicker = jpersian_datepicker;
//updated 
function jpersian_datepicker(elementID, opt) {
  // check arguments
  if (
    ...
    console.error(
      'Jawed Persian Date Picker error: input ID is not an object, string or is an empty strong!'
    );
    return;
  }
  var options = opt || {};
